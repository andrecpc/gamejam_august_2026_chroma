            ...
            tutorials=[
                {
                    ...
                    "trigger": "start",
                    "persist": "until-move",
                    "text": "Нажми на экран — появится стик. Его удобно держать внизу, там где корзины. Зажми стик и веди точку: с рамки заезжай в бумагу и возвращайся обратно на рамку. Когда контур замкнулся, в корзину своего цвета попадает меньший из отрезанных кусков.",
                },
                {
                    "id": "cut_keep_going",
                    "trigger": "cut",
            ...
            tutorials=[
                {
                    ...
                    "trigger": "start",
                    "persist": "until-move",
                    "text": "Красный кружок — враг. Он бегает по бумаге, и касание снимает жизнь. Если враг коснётся пунктирной линии реза — тоже будет больно. Наполни корзины и старайся его не задеть. Если замкнёшь контур вокруг врага, он пропадёт.",
                }
            ],
        ),
        base(
